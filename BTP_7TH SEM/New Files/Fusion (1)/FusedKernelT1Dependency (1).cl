 ...
 // float3
...

	{
...

		{
			...
			if(out[pixel.x + depthSize.x * pixel.y] > 0) {

				res = out[pixel.x + depthSize.x * pixel.y] * (myrotate(invK_data_0,invK_data_1,invK_data_2,invK_data_3, (float3)(pixel.x, pixel.y, 1.f)));
