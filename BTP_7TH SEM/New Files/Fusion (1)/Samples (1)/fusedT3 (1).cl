...
__kernel void fusedT3_boxFilter3x3_morph3x3(__global const uint* src, int src_step,
                         ...
                         )
{
    ...
    int X = FVALUE*(WORKGROUP_SIZE/BLOCK_SIZE)*(WORKGROUP_SIZE/BLOCK_SIZE)+OFFSET;
